...
- You can you can either use it in [voice agents](http://localhost:3000/voice-agents/knowledge-base) or [workflows](http://localhost:3000/workflow/agent-blocks#ai-query-agent).
