...
Function Blocks allow you to execute actions based on AI and user inputs. Please [contact us](https://www.subverseai.com/contact-us) if you weant to add any function block for custom integration.
...
**Inputs**
- **Greetings_message** – Greeting message voice agent will say to the customer, this will override [initial prompt](http://localhost:3001/voice-agents/prompting#initial-prompt) defined for the use case. This can be linked to a connecting block (AI generated greetings meesage based on previous conversation) or manually written. Data linkage will override the written text.
