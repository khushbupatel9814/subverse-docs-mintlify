...
- **Tool Outputs**: The block also produces outputs from the selected tools, which can be used as inputs to [function blocks](http://localhost:3001/workflow/function-blocks), allowing you to automate follow-up tasks or notifications.
